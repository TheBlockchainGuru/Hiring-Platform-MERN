...
const Login = () => {
  ...
  return (
    <>
      <Head>
        <title>Login | Hiring Platform</title>
      </Head>
      <Box
        component="main"
        sx={{
          ...
          <Card elevation={16} sx={{ p: 4 }}>
            ...
            >
              ...
              <Typography color="textSecondary" sx={{ mt: 2 }} variant="body2">
                Sign in on the hiring platform
              </Typography>
            </Box>
            <Box
              sx={{
            ...
            <Divider sx={{ my: 3 }} />
            <div>
              <NextLink href={disableGuard ? `/authentication/register?disableGuard=${disableGuard}` : "/authentication/register"} passHref>
