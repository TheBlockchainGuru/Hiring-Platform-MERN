  ...
  const popularAssessments = [
    {
      ...
      description:
        "A Recruiter is responsible for all aspects of recruiting from client management, candidate sourcing, and engagement and...",
      skills: ["TYPING", "SEO"],
    },
    {
      id: "5e887faca2b7a1ddce01221a",
          ...
          {assessmentTypes.map((ele, index) => {
            return (
              <Button
                variant="outlined"
                key={index}
                sx={{ mx: 1, my: { xs: 1, sm: "none" }, borderRadius: "50px" }}
              >
                {ele}
              </Button>
            );
...
AssessmentLibrary.getLayout = (page) => <CompanyLayout>{page}</CompanyLayout>;
